...
The system SHALL allow admin product create and update operations to initialize and maintain the product inventory item while preserving inventory integrity rules, and InventoryModule SHALL own inventory item persistence, inventory quantity validation, and inventory movement recording for those operations.
...
- THEN the system delegates inventory initialization to InventoryModule within the product create transaction
...
- WHEN `POST /admin/products` is called
- THEN the system delegates default inventory initialization to InventoryModule within the product create transaction
- AND creates exactly one inventory item for the product
...
- THEN the system delegates inventory updates to InventoryModule within the product update transaction
- AND updates the product inventory item
