...
Define the public ShopVN storefront foundation for the Next.js App Router web app, including canonical homepage route ownership, storefront layout, homepage sections, asset strategy, responsive behavior, accessibility, and verification boundaries.
## Requirements
